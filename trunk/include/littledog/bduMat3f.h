...
/*
 *  Copyright (C) 2006 Boston Dynamics
 *  ALL RIGHTS RESERVED.
 *
...
#ifndef __bduMat3f_H__
#define __bduMat3f_H__
...
public:
	...
	//!
	bduMat3f(InitialValues initial_values);
